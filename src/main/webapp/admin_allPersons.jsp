     ...
     <table border="1" width="100%">
     	...
     	<s:iterator value="pageInfo.pageData" var="person" status="status">
	     	<tr>
	     		...
	     		<td align="center"><a href="person/person_update?id=${person.id}&type=1">修改  </a> 
	     		<a href="javascript:goDeletePerson(${person.id })">删除  </a> <a href="person/person_detailPerson.action?id=${person.id }&type=2">详细</a></td>
